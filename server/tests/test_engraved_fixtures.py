...
def test_navigation_pdf_binds_every_mark_to_the_bar_it_is_engraved_over(engraved):
    ...
    and not one segno)". The library draws 156 coda signs across 143 files
    and 88 segnos across 84 files; that "not one segno" claim was a
    mislabelled row in the Maestro glyph table and is retracted in Rule 16.
    The fixture keeps its value on a better ground: it reaches
